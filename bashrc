...
alias g++='g++ -std=c++11'
alias apagar='echo <password>|sudo -S poweroff -p'
alias suspend='echo <password>|sudo -S pm-suspend'
alias hibernate='echo <password>|sudo -S pm-hibernate'
alias disk='echo <password>|sudo -S fdisk -l'
alias cls='clear'
alias vi='vim --cmd ":set nu"'
...
export PATH="/home/gabo/anaconda3/bin:$PATH"
